        ...
        return (
            <div id="ch-2-1" >
                ...
                <Row>
                    <Col>
                        <p>
                            May is a visual co-working space designed like a game that especially explores the art of creative writing. The visual elements help to keep the room sorted. If files are created without order, it shows in the room.
